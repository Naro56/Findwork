...
<div class="container">
    ...
    <?php if ($jobs->num_rows === 0): ?>
        <div class="alert alert-info">
            ...
            <a href="/post-job.php">Post your first job</a> to start receiving applications!
        </div>
    <?php else: ?>
        <div class="jobs-grid">
            <?php while ($job = $jobs->fetch_assoc()): ?>
                <div class="job-card">
                    ...
                    <div class="job-details">
                        ...
                        <p><i class="fas fa-briefcase"></i> <?php echo htmlspecialchars($job['experience_required']); ?></p>
                        <p><i class="fas fa-clock"></i> <?php echo htmlspecialchars($job['type']); ?></p>
                    </div>
